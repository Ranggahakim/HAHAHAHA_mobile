...
public class movement : MonoBehaviour
{
    ...
    [SerializeField]bool UIForward;
    public GameObject UIB;
    [SerializeField]bool UIBack;
    public GameObject UIRR;
    [SerializeField]bool UIRotateR;
    public GameObject UIRL;
    [SerializeField]bool UIRotateL;
    ...
    void Update()
    {
        UIForward = UIF.GetComponent<forward_UI>().UIForward;
        UIBack = UIB.GetComponent<back_UI>().UIback;
        UIRotateR = UIRR.GetComponent<rotateR_UI>().UIRotateR;
        UIRotateL = UIRL.GetComponent<rotateL_UI>().UIRotateL;
    ...
    void move()
    {
        ...
        if(player == 2)
        {
            if(UIForward)
            {
                moveDir = transform.TransformDirection(new Vector3(0,0, 1));
                myController.Move(moveDir * speed * Time.deltaTime);
            }
            if(UIBack)
            {
